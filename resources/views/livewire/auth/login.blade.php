<div>
    ...
    <form class="space-y-2 md:space-y-4" autocomplete="off" wire:submit.prevent="login">
        <div>
        ...
        <div class="flex items-start">
            <div class="flex items-center h-5">
                <input id="terms" aria-describedby="terms" type="checkbox"
                    class="w-4 h-4 border text-yellow-600 border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-yellow-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-yellow-600 dark:ring-offset-gray-800"
                    wire:model="remember">
            </div>
        ...
        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
            ...
            <a href="{{ route('register') }}" class="font-medium text-yellow-600 hover:underline dark:text-yellow-500">
                Registrate aqui
            </a>
        </p>

        <div class="flex flex-col items-center justify-between">
            <button type="button" class="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mr-2 mb-2 w-full justify-center">
            ...
            <button type="button" class="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mr-2 mb-2 w-full justify-center">
